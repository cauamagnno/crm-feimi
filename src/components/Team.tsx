...
const Team: React.FC = () => {
  ...
  return (
    <div className="p-8 h-full overflow-y-auto bg-background text-foreground relative custom-scrollbar">
      ...
      {/* Main Table Card */}
      <div className="bg-card/30 border border-border rounded-xl overflow-hidden shadow-xl">
                            ...
                            <tr key={member.id} className="hover:bg-muted/20 transition-colors group">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <div className="flex items-center gap-3">
                                        <div className="flex-shrink-0 w-9 h-9 rounded-full bg-muted flex items-center justify-center text-xs font-bold text-muted-foreground border border-border uppercase">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <input
                                        ...
                                        className="w-16 px-2 py-1 bg-background border border-border rounded-md text-sm text-muted-foreground text-center"
                                    />
                                </td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 backdrop-blur-sm backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-card border border-border rounded-xl shadow-2xl max-w-md w-full overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                <form onSubmit={handleInvite} className="p-6 space-y-4">
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-muted-foreground">Time (opcional)</label>
                        <select
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-muted-foreground">Função (opcional)</label>
                        <select
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-muted-foreground">Peso (para distribuição)</label>
                        <input
                            type="number"
                            min="1"
                            max="10"
