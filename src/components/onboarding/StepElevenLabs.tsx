    ...
    >
      ...
      <div className="space-y-6 max-w-md mx-auto">
        ...
        <motion.div variants={itemVariants} className="space-y-2">
          <Label htmlFor="elevenLabsApiKey" className="text-muted-foreground flex items-center gap-2">
        ...
        {/* Voice Selector */}
        <motion.div variants={itemVariants} className="space-y-2">
          <Label className="text-muted-foreground">Voz</Label>
        ...
        <motion.div variants={itemVariants} className="space-y-4 p-4 rounded-lg bg-muted/20 border border-border/30">
          <h4 className="text-sm font-medium text-muted-foreground">Ajustes da Voz</h4>
